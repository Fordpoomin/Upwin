...
<body>
    ...
    <div class="container" style="padding-top: 100px;">
        <div class="row">
            <div class="col-md-12">
                <img src="./img/user.png" alt="Paris" class="center">
            </div>
        </div>
        <h2 style="text-align: center; padding-bottom: 10px;">ลงทะเบียน</h2>
        <h2 style="text-align: center; padding-bottom: 10px;">บุคคลากร</h2>

        <form id="one" name="one" method="post" action="" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-group">
                <div class="col">
                    <select class="custom-select" name="select_faculty" id="select_faculty" required>
                        <option selected="true" disabled="disabled">เลือกคณะหรือสังกัด</option>
                        <?php
    ...
    <script type="text/javascript" src="./js/three-register.js"></script>
