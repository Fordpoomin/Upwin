...
<body>
    ...
    <div style="margin:50px; padding-top: 50px;">
        <h3>ดู สถิติเข้า-ออก</h3><br>
        <div class="row">

            <div class="col-md-12">
                <table class="table table-bordered" id="stats" cellspacing="0" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>ชื่อผู้ใช้</th>
    ...
    <script type="text/javascript" src="./js/home_history.js"></script>
